...
const InfoTotalTodo = ({ todosLength, deleteAllTodo, totalCompletedCount, totalUncompletedCount, disabled }) => {
	return (
		<div className="d-flex justify-content-between align-items-center pt-4 pb-3">
			...
			<button
				onClick={() => {
					if (window.confirm("Apakah Anda yakin ingin menghapus semua daftar pekerjaan Anda?")) deleteAllTodo();
				}}
