	...
	return (
		<>
			...
			<form onSubmit={handleSubmit} className={styles.centerForm}>
				...
				<label>
					No Handphone: <br />
					<input required type="number" name="noHandphone" value={data.noHandphone} onChange={handleChange} />
				</label>
				<label>
				...
				<label>
					...
					<select required type="text" name="kelas" id="kelas" value={data.kelas} onChange={handleChange}>
						...
						<option value="reactjs" name="reactjs">
				...
				<button data-testid="reset-button" className={styles.buttonReset} onClick={resetForm}>
					Reset
				</button>
			</form>
		</>
